...
<html>
  ...
  function checkEmail() {
    ...
    <body>
    <center> <h3 style="margin-top:40px;"> Registration Form</h3></center><hr style="width:400px;">
    <center> 
        ...
        try
          {                    
            ...
            if(name!=null)
                {  
                    s="insert into user values('"+name+"','"+email+"','"+password+"','"+mobile+"','"+address+"')";
                    Statement stmt=con.createStatement();
                    ResultSet check= stmt.executeQuery("select * from user where email='"+email+"'");
                    if(check.next())
                    {
