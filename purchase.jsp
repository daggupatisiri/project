...
<%
  try
  {
        ...
        s="insert into purchase values('"+name+"','"+email+"','"+mobile+"','"+state+"','"+city+"','"+pin+"','"+address+"','"+brand+"','"+ status+"','"+"__"+"','"+product_id+"','"+"___"+"' )";
         if(name!=null)
          {
        ...
        if(x==1)
        {
            out.println("Item Has not Been Confirmed pls purchase once again");
        }
    } 
